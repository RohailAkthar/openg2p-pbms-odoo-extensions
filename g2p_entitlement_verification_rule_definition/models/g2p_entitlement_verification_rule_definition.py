...
class G2PEntitlementVerificationRuleDefinition(models.Model):
    _name = 'g2p.entitlement.verification.rule.definition'
    _description = 'G2P Entitlement Verification Rule Definition'
