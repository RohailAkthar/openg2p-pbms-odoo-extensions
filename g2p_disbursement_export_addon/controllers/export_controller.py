            ...
            def generate_csv_chunks():
                ...
                while more_records:
                    ...
                    for b in beneficiaries:
                        hh_name = str(b.get('name') or b.get('head_name') or '').strip()
                        ...
                        head_name = str(b.get('head_name') or '').strip()

                        raw_gender = str(b.get('head_gender') or '').strip().lower()
                        ...
                        head_phone = str(b.get('head_phone') or '').strip()
